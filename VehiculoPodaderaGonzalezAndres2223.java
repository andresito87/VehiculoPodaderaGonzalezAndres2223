 ...
 */
public class VehiculoPodaderaGonzalezAndres2223 {
    ...
    public VehiculoPodaderaGonzalezAndres2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoPodaderaGonzalezAndres2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
